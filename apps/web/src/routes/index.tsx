...
function HomePage() {
  ...
  return (
    <div className="flex h-dvh flex-col bg-background">
              ...
              trigger={
                <button className="flex w-full items-center gap-3 rounded-xl p-2 text-left transition-colors hover:bg-muted/50 active:bg-muted">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">点击编辑个人信息</p>
                  </div>
                </button>
              }
            />
      ...
      <ScanRoomSheet open={scanOpen} onOpenChange={setScanOpen} onScanSuccess={handleScanSuccess} />
      ...
      <main className="flex min-h-0 flex-1 flex-col">
        ...
        {rooms.length > 0 && (
          <div className="flex min-h-0 flex-1 flex-col px-4 sm:px-6">
            ...
            <div ref={roomListContainerRef} className="min-h-0 flex-1 overflow-hidden">
