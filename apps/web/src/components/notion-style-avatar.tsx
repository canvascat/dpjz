...
import { AVATAR_MAP, NOTION_AVATAR_LAYER_ORDER, getNotionAvatarConfig } from "@/lib/notion-avatar";
...
export function NotionStyleAvatar({
  ...
  }, [config.face, config.nose, config.mouth, config.eyes, config.eyebrows, config.hair, failed]);
